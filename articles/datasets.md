...
Use this guide to choose a generated or externally supplied dataset,
check what is required to obtain it, and continue with the appropriate
result shape. The functions below are representative; use the complete
[function
reference](https://jlmelville.github.io/snedata/reference/index.md) for
the full catalogue and argument details.

## Choose a dataset

| Choose this when you need… | Dataset family | Representative functions | Acquisition and scale |
|----|----|----|----|
| A simple manifold or curve with a controllable sample size | Basic synthetic data | [`sphere()`](https://jlmelville.github.io/snedata/reference/sphere.md), [`ball()`](https://jlmelville.github.io/snedata/reference/ball.md), [`helix()`](https://jlmelville.github.io/snedata/reference/helix.md), [`swiss_roll()`](https://jlmelville.github.io/snedata/reference/swiss_roll.md), [`s_curve()`](https://jlmelville.github.io/snedata/reference/s_curve.md) | Generated locally; choose the number of rows. |
| Cluster and geometry stress tests from *How to Use t-SNE Effectively* | Distill t-SNE simulations | [`gaussian_data()`](https://jlmelville.github.io/snedata/reference/gaussian_data.md), [`two_clusters_data()`](https://jlmelville.github.io/snedata/reference/two_clusters_data.md), [`random_walk()`](https://jlmelville.github.io/snedata/reference/random_walk.md), [`trefoil_data()`](https://jlmelville.github.io/snedata/reference/trefoil_data.md) | Generated locally; choose the number of rows. |
| Paper-derived topology or hierarchy examples | PaCMAP and topological examples | [`s_curve_hole()`](https://jlmelville.github.io/snedata/reference/s_curve_hole.md), [`curve2d()`](https://jlmelville.github.io/snedata/reference/curve2d.md), [`synthetic_hierarchical_data()`](https://jlmelville.github.io/snedata/reference/synthetic_hierarchical_data.md), [`taspheres()`](https://jlmelville.github.io/snedata/reference/taspheres.md) | Generated locally; size is controlled by function arguments. |
| A fixed 3D point cloud for embedding experiments | Mammoth point clouds | [`download_mammoth10k()`](https://jlmelville.github.io/snedata/reference/download_mammoth10k.md), [`download_mammoth50k()`](https://jlmelville.github.io/snedata/reference/download_mammoth50k.md) | Downloaded JSON; 10,000 or 50,000 rows. |
...
set to 60,000 digits, giving 120,000 rows in total.

## Generate a local dataset

Synthetic datasets need no download or optional package. Here, the seed
makes the sampled points reproducible.
...
The result has 200 rows, three coordinate columns, and a color column.
The coordinate norm is 1 for every row, confirming that the points lie

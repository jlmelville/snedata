...
Creates a 3D dataset where points are uniformly sampled from a trefoil
knot. Points are colored based on mapping the angle parameter values
used to generate the knot coordinates to a rainbow color scheme.

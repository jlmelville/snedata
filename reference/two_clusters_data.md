...
- dim:
  ...
  Dimension of the gaussians. You may pass a vector of length 2 to
  create clusters of different dimensionalities, with the smaller
  cluster having zeros in the extra dimensions.
...
with equal number of points and standard deviation 1, separated by a
distance of 10 units. Points are colored depending on which cluster they
belong to.
